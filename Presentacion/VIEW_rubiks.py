...
class Ui_frm_principal(object):
    ...
    def setupUi(self, frm_principal):
        ...
        self.lbl_realizar_giro_2.setGeometry(QtCore.QRect(10, 520, 141, 31))
        font = QtGui.QFont()
        ...
        self.btn_deshacer_ult_mov = QtWidgets.QPushButton(self.pnl_central)
        self.btn_deshacer_ult_mov.setGeometry(QtCore.QRect(880, 450, 221, 41))
        ...
        self.debug_area.setGeometry(QtCore.QRect(700, 550, 411, 181))
        self.debug_area.setReadOnly(True)
        self.debug_area.setObjectName("debug_area")
        self.btn_limpiar_movimientos = QtWidgets.QPushButton(self.pnl_central)
        self.btn_limpiar_movimientos.setGeometry(QtCore.QRect(880, 400, 221, 41))
        self.btn_limpiar_movimientos.setDefault(False)
        self.btn_limpiar_movimientos.setFlat(False)
        self.btn_limpiar_movimientos.setObjectName("btn_limpiar_movimientos")
        self.lbl_cubo_cargado = QtWidgets.QLabel(self.pnl_central)
        self.lbl_cubo_cargado.setGeometry(QtCore.QRect(427, 567, 261, 91))
        font = QtGui.QFont()
        ...
        self.lbl_size_cubo_cargado.setGeometry(QtCore.QRect(430, 670, 251, 51))
        font = QtGui.QFont()
        font.setPointSize(21)
        ...
        self.table_nodo_actual.setGeometry(QtCore.QRect(0, 550, 411, 181))
        ...
        self.lst_movimientos_realizados = QtWidgets.QListWidget(self.pnl_central)
        self.lst_movimientos_realizados.setGeometry(QtCore.QRect(870, 0, 241, 391))
        ...
        self.lbl_realizar_giro_3.setGeometry(QtCore.QRect(1010, 520, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, frm_principal):
        ...
        self.btn_limpiar_movimientos.setText(_translate("frm_principal", "Limpiar movimientos"))
...
# --------------- HASTA AQUI LO QUE HA SIDO GENERADO AUTOMATICAMENTE --------
    ...
    def setActions(self):
        ...
        self.btn_limpiar_movimientos.clicked.connect(lambda: self.controller.clearHistorial())
